...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
            --green: #00C853; --teal: #00897B; --dark: #0a0f0d;
            --sidebar-bg: #111a14; --chat-bg: #0d1510;
            --bubble-out: #005c4b; --bubble-in: #1e2d22;
            --border: rgba(0,200,83,0.14); --text: #e8f5e9;
            --muted: #6b8f71; --error: #ff5252;
        }
        ...
        .contact-email { font-size: 0.75rem; color: var(--muted); }
        ...
        .add-contact-btn { margin: 12px; padding: 10px; background: rgba(0,200,83,0.08); border: 1px dashed var(--border); border-radius: 10px; color: var(--green); font-family: 'Sora', sans-serif; font-size: 0.85rem; font-weight: 600; cursor: pointer; width: calc(100% - 24px); transition: background 0.2s; }
        .add-contact-btn:hover { background: rgba(0,200,83,0.15); }
